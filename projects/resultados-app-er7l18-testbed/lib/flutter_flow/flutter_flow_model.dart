...
abstract class FlutterFlowModel<W extends Widget> {
  ...
  // Action Output Registry for TeamSoft instrumentation
  ...
  void onUpdate() {
    ...
    try {
      final stateName = _widget?.runtimeType?.toString() ?? 'Model';
      Map<String, dynamic> vars = {};
      try {
         if (this is dynamic) {
           vars = (this as dynamic).ts_toMap();
         }
      } catch(e) {
         vars['_ts_updated'] = DateTime.now().millisecondsSinceEpoch;
      }
  ...
  // TeamSoft instrumentation: to be overridden by generated models
