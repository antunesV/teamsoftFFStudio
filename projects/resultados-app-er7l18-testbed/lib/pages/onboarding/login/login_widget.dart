...
class _LoginWidgetState extends State<LoginWidget> {
  ...
  Widget build(BuildContext context) {
                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'uazf8eou' /* Entre com o NIF associado à su... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'hkcf9ko7' /* Insira sua senha abaixo para a... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                                              ...
                                                              'password':
                                                                ...
                                                                'validation':
                                                                  ...
                                                                  'rule':
                                                                    ...
                                                                    <String,
                                                                        String?>{
                                                                      'value': teamsoft_library_8991ti_enums
                                                                          .ValidationRules
                                                                          .REQUIRED
                                                                          .name,
                                                                    },
    ...
    try { _model.actionOutputRegistry['outputValidateData'] = _model.outputValidateData; } catch(_) {}
    try { _model.actionOutputRegistry['outputValidateData'] = _model.outputValidateData; } catch(_) {}
    try { _model.actionOutputRegistry['outputValidateData'] = _model.outputValidateData; } catch(_) {}
    try { _model.actionOutputRegistry['outputValidateData'] = _model.outputValidateData; } catch(_) {}
    try { _model.actionOutputRegistry['outputValidateData'] = _model.outputValidateData; } catch(_) {}
    ...
    try { _model.actionOutputRegistry['loginOutput'] = _model.loginOutput; } catch(_) {}
    try { _model.actionOutputRegistry['loginOutput'] = _model.loginOutput; } catch(_) {}
    try { _model.actionOutputRegistry['loginOutput'] = _model.loginOutput; } catch(_) {}
    try { _model.actionOutputRegistry['loginOutput'] = _model.loginOutput; } catch(_) {}
    try { _model.actionOutputRegistry['loginOutput'] = _model.loginOutput; } catch(_) {}
